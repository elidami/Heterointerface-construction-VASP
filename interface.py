...
reference_site_metal = functions.metal_fcc_111_high_symmetry_points("clean_interface_files/upper_slab.txt",selected_site_metal)
reference_site_C = functions.C_111_high_symmetry_points("clean_interface_files/bottom_slab.txt", selected_site_C)
shifted_upper_slab_on_xy = functions.shift_slab_on_xy("clean_interface_files/upper_slab.txt", reference_site_metal,reference_site_C)
